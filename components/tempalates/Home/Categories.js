    ...
    <>
      <div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-1.5  justify-items-center w-[90%] mx-auto mt-2.5">
          <div className=" w-35 h-50 sm:w-35 sm:h-45  md:w-45 md:h-62.5 bg-white/40 shadow-2xl relative hover:scale-105">
            <img
          ...
          <div className="w-35 h-50 sm:w-35 sm:h-45 md:w-45 md:h-62.5 bg-white/40 shadow-2xl relative hover:scale-105">
            ...
            <div className=" opacity-0 hover:opacity-100 absolute inset-0 w-full h-full  backdrop-blur-[2px] flex justify-center items-center text-[22px] text-center text-white font-bold">
              Cakes & Desserts
            </div>
          </div>
          <div className="w-35 h-50  sm:w-35 sm:h-45 md:w-45 md:h-62.5 bg-white/40 shadow-2xl relative hover:scale-105">
          ...
          <div className="w-35 h-50 sm:w-35 sm:h-45 md:w-45 md:h-62.5 bg-white/40 shadow-2xl relative hover:scale-105 max-sm:col-span-2 max-sm:justify-self-center">
